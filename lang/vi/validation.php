...
return [
    ...
    */
    ...
    'deadline' => [
        'required' => 'Vui lòng chọn hạn chót cho công việc',
        'date' => 'Định dạng hạn chót không hợp lệ',
        'after_or_equal' => 'Hạn chót phải là ngày hôm nay hoặc sau đó',
    ],
    'status' => [
        'required' => 'Trạng thái không được để trống',
        'in' => 'Trạng thái chỉ được phép: Chưa làm, Đang làm, Hoàn thành',
    ],
    'priority' => [
        'required' => 'Vui lòng chọn mức độ ưu tiên',
        'in' => 'Ưu tiên chỉ được phép: Thấp, Trung bình, Cao',
    ],
    'assigned_to' => [
        'required' => 'Vui lòng chỉ định người được giao',
        'integer' => 'Id người được giao phải là số nguyên',
        'exists' => 'Người được giao không tồn tại trong hệ thống',
    ],
